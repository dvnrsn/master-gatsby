  ...
  return <>
    ...
    <OrderStyles onSubmit={submitOrder}>
      <fieldset disabled={loading}>
        ...
        <input type="text" name="coupon" onChange={updateValue}/>
      </fieldset>
      <fieldset className='menu'>
        <legend>Menu</legend>
        {pizzas.map(pizza => (
          <MenuItemStyles key={pizza.id}>
            <Img width="50" height="50" alt={pizza.name} fluid={pizza.image.asset.fluid}></Img>
      ...
      <fieldset className='menu'>
        <legend>Order</legend>
        <PizzaOrder pizzas={pizzas} order={order} removeFromOrder={removeFromOrder} />
      </fieldset>
      <fieldset>
